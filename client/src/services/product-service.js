...
export class ProductService extends ServiceBase {
    ...
    getProductAdmin = async (params) => {
        ...
        return await this.get(`/getProducts?name[regex]=${name}&limit=${limit}&page=${page}`);
    };
    ...
    getProductByCategory = async (params) => {
        ...
        return await this.get(`/getProducts?category=${category}&limit=${limit}&page=${page}&sort=${sort}`);
    };
